 ...
 * 
 * Note: This file is for frontend use. Node.js-specific types are adapted
...
/**
 * Signal type (adapted from NodeJS.Signals for browser compatibility).
 */
...
export interface SessionRecord {
  ...
  /** Agent exit signal */
  lastAgentExitSignal?: SignalType;
  /** ISO timestamp */
